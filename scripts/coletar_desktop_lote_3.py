#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Desktop, lote 3, no mesmo modelo validado da Claro."""
...
SAIDA=RAIZ/'dados'/'piloto-desktop-lote-3.json'
EVID=RAIZ/'evidencias-desktop-lote-3'
...
def main():
    ...
    d={'operator':'Desktop','mode':'lote_3','generated':agora(),'citiesExpected':len(CIDADES),'results':[],'productionFilesChanged':False}
