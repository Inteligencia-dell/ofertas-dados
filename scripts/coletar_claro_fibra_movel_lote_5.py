...
SAIDA = RAIZ / "dados" / "piloto-claro-fibra-movel-lote-5.json"
EVIDENCIAS = RAIZ / "evidencias-claro-fibra-movel-lote-5"
...
def main():
    ...
    with sync_playwright() as p:
        ...
        browser.close()
    payload = {
        "meta": {"generated": agora(), "mode": "piloto_claro_fibra_movel_lote_5", "productionFilesChanged": False},
        "summary": {
