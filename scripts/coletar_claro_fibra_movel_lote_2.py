...
SAIDA = RAIZ / "dados" / "piloto-claro-fibra-movel-lote-2.json"
EVIDENCIAS = RAIZ / "evidencias-claro-fibra-movel-lote-2"
...
def main():
    ...
    with sync_playwright() as p:
        ...
        browser.close()
    payload = {
        "meta": {"generated": agora(), "mode": "piloto_claro_fibra_movel_lote_2", "productionFilesChanged": False},
        "summary": {
