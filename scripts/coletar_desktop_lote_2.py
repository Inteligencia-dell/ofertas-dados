#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Desktop, lote 2, no mesmo modelo validado da Claro."""
...
SAIDA=RAIZ/'dados'/'piloto-desktop-lote-2.json'
EVID=RAIZ/'evidencias-desktop-lote-2'
...
def main():
    ...
    d={'operator':'Desktop','mode':'lote_2','generated':agora(),'citiesExpected':len(CIDADES),'results':[],'productionFilesChanged':False}
