...
SAIDA = RAIZ / "dados" / "piloto-claro-fibra-movel-lote-7.json"
EVIDENCIAS = RAIZ / "evidencias-claro-fibra-movel-lote-7"
...
def main():
    ...
    with sync_playwright() as p:
        ...
        browser.close()
    payload = {
        "meta": {"generated": agora(), "mode": "piloto_claro_fibra_movel_lote_7", "productionFilesChanged": False},
        "summary": {
