#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Desktop, lote 5, no mesmo modelo validado da Claro."""
...
SAIDA=RAIZ/'dados'/'piloto-desktop-lote-5.json'
EVID=RAIZ/'evidencias-desktop-lote-5'
...
def main():
    ...
    d={'operator':'Desktop','mode':'lote_5','generated':agora(),'citiesExpected':len(CIDADES),'results':[],'productionFilesChanged':False}
