#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Desktop, lote 1, no mesmo modelo validado da Claro."""
...
SAIDA=RAIZ/'dados'/'piloto-desktop-lote-1.json'
EVID=RAIZ/'evidencias-desktop-lote-1'
...
def main():
    ...
    d={'operator':'Desktop','mode':'lote_1','generated':agora(),'citiesExpected':len(CIDADES),'results':[],'productionFilesChanged':False}
