...
SAIDA = RAIZ / "dados" / "piloto-claro-fibra-movel-lote-4.json"
EVIDENCIAS = RAIZ / "evidencias-claro-fibra-movel-lote-4"
...
def main():
    ...
    with sync_playwright() as p:
        ...
        browser.close()
    payload = {
        "meta": {"generated": agora(), "mode": "piloto_claro_fibra_movel_lote_4", "productionFilesChanged": False},
        "summary": {
