...
SAIDA = RAIZ / "dados" / "piloto-claro-fibra-movel-20-cidades.json"
EVIDENCIAS = RAIZ / "evidencias-claro-fibra-movel-20-cidades"
...
def main():
    ...
    with sync_playwright() as p:
        ...
        browser.close()
    payload = {
        "meta": {"generated": agora(), "mode": "piloto_claro_fibra_movel_20_cidades", "productionFilesChanged": False},
        "summary": {
